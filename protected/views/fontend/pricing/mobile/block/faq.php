        ...
        <div class="col-xs-12">
            ...
            if (Yii::app()->controller->action->id == 'sale') {
                ...
                <div class="support-img">
                    <a name="lienhe"></a>
                    <img class="img-responsive" src="/images/sale/mobile/support_01.png" alt=""/>
                    <br />
                    <img class="img-responsive" src="/images/sale/mobile/support_02.png" alt=""/>
                </div>
                <?php
            }
            ?>
            <a name="faq"></a>
            <p class="title"><?php echo $this->t(2, 'heading', 'pricing') ?></p>
