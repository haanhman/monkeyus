        ...
        <div class="col-xs-12">
            ...
            <div class="video">
                ...
                <div class="col-xs-12 videointro text-center">
                    <img class="img-responsive" src="/monkeyweb/images/video_vtv2.png"/>
                    <div class="youtube embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" class="embed-responsive-item"
                                src="//www.youtube.com/embed/W3w_DjdWwas" allowfullscreen></iframe>
                    </div>
            ...
            <div class="danhsachbaibao">
                ...
                ?>
                <ul class="baochi-list list-unstyled">
                    <?php
                    foreach ($list as $item) {
                        ?>
                        <li>
                            <h2><a target="_blank" rel="nofollow"
                                   href="<?php echo $item['url'] ?>"><?php echo $item['title'] ?></a></h2>
                            <p class="time"><span><a rel="nofollow" target="_blank"
                                                     href="<?php echo $item['url'] ?>"><?php echo $item['source'] ?></a>
                            </p>
                            <p class="lead">"<?php echo $item['intro'] ?>"</p>
