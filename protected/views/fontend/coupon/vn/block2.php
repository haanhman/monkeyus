...
<div class="cp-block2">
    <div class="inner">
        <p class="text-center desc_box">
            <strong class="lead">1. Cài đặt ứng dụng - Nhận +30 bài học miễn phí</strong>
        </p>
        <ul class="store">
        ...
        <div class="clearfix"></div>
        <p class="text-center desc_box">
            <strong class="lead">2. Mua trọn gói nội dung - Giảm giá 40%</strong>
        </p>
        <div class="clearfix"></div>
