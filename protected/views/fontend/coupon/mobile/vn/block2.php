...
<div class="cp-block2">
    <div class="inner">
        <p class="text-center desc_box">
            <strong class="lead">1. Cài đặt ứng dụng<br /><span>Nhận +30 bài học miễn phí</span></strong>
        </p>
        <ul class="store list-unstyled text-center">
        ...
        <div class="clearfix"></div>
        <p class="text-center desc_box">
            <strong class="lead">2. Mua trọn gói nội dung<br /><span>Giảm giá 40%</span></strong>
        </p>
        <div class="clearfix"></div>        
