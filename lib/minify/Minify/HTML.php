...
class Minify_HTML {
    ...
    public function process()
    {
        ...
        //$this->_html = preg_replace('/(<[a-z\\-]+)\\s+([^>]+>)/ism', "$1 $2", $this->_html);
    ...
    protected function _removeScriptCB($m)
    {
        ...
        $js = preg_replace('/(?:^\\s*<!--\\s*|\\s*(?:\\/\\/)?\\s*-->\\s*$)/ism', '&nbsp;', $js);
