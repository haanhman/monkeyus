...
$(window).load(function () {
    ...
    var filmView = parseInt($.cookie('edu_total_download_new'));
...
function countdown(filmView) {
    ...
    if (startPlus > 0) {
        ...
        $(".total-download .count").html(numberWithCommas(startPlus));
        ...
        $(".total-download .count").html(numberWithCommas(filmView));
    }
}
